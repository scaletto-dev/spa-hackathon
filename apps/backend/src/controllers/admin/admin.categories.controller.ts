...
class AdminCategoriesController {
  ...
  async createServiceCategory(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      if (existingSlug) throw new ValidationError('Service category slug already exists');
  ...
  async createBlogCategory(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      if (existingSlug) throw new ValidationError('Blog category slug already exists');
   ...
   */
  async deleteBlogCategory(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const id = req.params.id as string;
      if (!id) throw new ValidationError('Category ID is required');
