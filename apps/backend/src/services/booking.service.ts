...
export class BookingService {
   ...
   async getBookingByReference(
      ...
      if (email && booking.guestEmail && booking.guestEmail.toLowerCase() !== email.toLowerCase()) {
   ...
   async cancelBooking(
      ...
      if (!booking.guestEmail || booking.guestEmail.toLowerCase() !== cancelData.email.toLowerCase()) {
         throw new ValidationError(
