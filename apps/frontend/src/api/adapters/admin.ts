...
export const adminProfileAPI = {
    ...
    // PUT /profile
    updateProfile: async (data: { fullName?: string; phone?: string; language?: string; avatar?: string }) => {
...
export const adminCustomersAPI = {
    ...
    // POST /customers
    create: async (data: { email: string; phone: string; fullName: string; language?: string }) => {
...
export const adminCategoriesAPI = {
    ...
    service: {
        ...
        getAll: async (page = 1, limit = 10) => {
            return apiCall('GET', `/categories/service?page=${page}&limit=${limit}`);
        },
...
export const uploadAPI = {
    ...
    uploadImage: async (file: File, folder: 'blog' | 'branches' | 'profile' | 'service' = 'blog') => {
