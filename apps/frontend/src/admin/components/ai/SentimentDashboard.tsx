...
export const SentimentDashboard: React.FC<SentimentDashboardProps> = ({ period = 'month', onPeriodChange }) => {
            ...
            <div className={`${sentimentBg} rounded-lg p-4 mb-6`}>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='text-right'>
                        ...
                        <span className='text-lg font-semibold text-green-600'>{data.overall.change}</span>
                    </div>
                </div>
            </div>
