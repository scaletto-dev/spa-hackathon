...
export const AIBlogGeneratorModal: React.FC<AIBlogGeneratorModalProps> = ({ isOpen, onClose, onInsert }) => {
                    ...
                    <div className='flex items-center justify-between p-6 border-b border-gray-200'>
                        <div className='flex items-center gap-3'>
                            ...
                            <div>
                                ...
                                <p className='text-sm text-gray-500'>Tạo nội dung blog tự động bằng AI</p>
                            </div>
                        </div>
                            ...
                            <div className='space-y-6'>
                                ...
                                <div>
                                    ...
                                    <p className='mt-1 text-sm text-gray-500'>
                                        Tối đa 10 keywords. Nếu để trống, AI sẽ tự chọn keywords phù hợp.
                                    </p>
                                </div>
                            ...
                            <div className='space-y-6'>
                                ...
                                {generatedContent.excerpt && (
                                    <div>
                                        <div className='flex items-center justify-between mb-2'>
                                            ...
                                            <button
                                                onClick={() => handleCopy('excerpt', generatedContent.excerpt)}
                                                className='text-sm text-purple-600 hover:text-purple-700 flex items-center gap-1'
                                            >
                                                {copiedField === 'excerpt' ? (
                                                    <>
                                        ...
                                        <div className='p-4 bg-gray-50 rounded-lg border border-gray-200'>
                                            <p className='text-gray-700 text-sm'>{generatedContent.excerpt}</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div>
                                    <div className='flex items-center justify-between mb-2'>
                                        ...
                                        <button
                                            onClick={() => handleCopy('content', generatedContent.content)}
                                            className='text-sm text-purple-600 hover:text-purple-700 flex items-center gap-1'
                                        >
                                            {copiedField === 'content' ? (
                                                <>
