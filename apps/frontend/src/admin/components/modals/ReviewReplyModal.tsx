    ...
    return (
        <>
            ...
            <div className="!fixed !inset-0 !m-0 !p-0 flex items-center justify-center z-[10000] pointer-events-none">
                <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col animate-in fade-in slide-in-from-bottom-4 pointer-events-auto">
                    {/* Header */}
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-700">
                                        Absolutely amazing experience! The therapist was so
                                        professional and the results were incredible.
                                    </p>
                                </div>
                            </div>
                        </div>
