...
export function Header({ onMenuClick }: HeaderProps) {
    ...
    return (
        <header className="h-16 bg-white/80 backdrop-blur-lg border-b border-pink-100 flex items-center justify-between px-4 md:px-6 shadow-sm sticky top-0 z-40">
            {/* Left: Menu + Search */}
            ...
            <div className="flex items-center gap-2 md:gap-4">
                ...
                <div className="relative" ref={profileRef}>
                    ...
                    {showProfileMenu && (
                        <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-pink-100 py-2 z-50">
