                    ...
                    <div className='flex-1 p-4 overflow-y-auto space-y-4'>
                        <div className='bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-4 border border-purple-100'>
                            <p className='text-sm text-gray-700 mb-3'>
                                Hi! I'm your AI assistant. I can help you with insights, summaries, and recommendations.
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className='bg-white rounded-2xl rounded-tl-sm p-3 shadow-sm border border-pink-100 flex-1'>
                                <p className='text-sm text-gray-700'>
                                    Your top service this week is "Luxury Facial Treatment" with 127 bookings, up 18%
                                    from last week!
                                </p>
                            </div>
                        </div>
                    ...
                    <div className='p-4 border-t border-pink-100'>
                        <div className='flex gap-2'>
                            <input
                                ...
                                className='flex-1 px-4 py-2 rounded-full bg-pink-50/50 border border-pink-100 focus:outline-none focus:ring-2 focus:ring-pink-300 text-sm'
                            />
