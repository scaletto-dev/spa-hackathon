        ...
        <div className='space-y-6'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <p className='text-gray-600 mt-1'>{t('admin.services.subtitle')}</p>
                </div>
            ...
            <div className='bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-4 border border-purple-100'>
                <div className='flex items-center gap-2'>
                    ...
                    <p className='text-sm text-gray-700'>
                        <span className='font-semibold'>{t('admin.services.aiSuggestion')}:</span>{' '}
                        {t('admin.services.aiSuggestionText')}
                    </p>
                        ...
                        <div className='p-5'>
                            ...
                            <div className='flex items-center gap-2 pt-4 border-t border-pink-100'>
                                ...
                                <button
                                    ...
                                    aria-label={
                                        service.visible ? t('admin.services.visible') : t('admin.services.hidden')
                                    }
                                >
                                    {service.visible ? (
