...
export function Branches() {
    ...
    const {
        ...
        goToPage,
        setPageSize,
    } = useAdminList(adminBranchesAPI.getAll);
                        ...
                        >
                            <div className="relative h-48 overflow-hidden bg-gray-200">
                                ...
                                <div className="absolute top-3 right-3 flex items-center gap-2">
                                    <span
                                        className={`${branch.active ? 'bg-green-500' : 'bg-gray-400'} text-white px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1`}
                                    >
