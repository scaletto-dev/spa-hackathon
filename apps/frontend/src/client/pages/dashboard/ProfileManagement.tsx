            ...
            <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 pt-20">
                <div className="flex items-center justify-center py-20">
                    ...
                    <span className="ml-3 text-gray-600">
                        {t('profileManagement.loadingProfile')}
                    </span>
                </div>
            </div>
        );
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-8 border border-purple-100">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        {t('profileManagement.fullNameLabel')}{' '}
                                ...
                                <div>
                                    <label
                                        ...
                                        className="block text-sm font-semibold text-gray-700 mb-3"
                                    >
                                        {t('profileManagement.phoneLabel')}{' '}
                                        <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        type="tel"
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        value={language}
                                        onChange={(e) =>
                                            setLanguage(e.target.value as 'vi' | 'ja' | 'en' | 'zh')
                                        }
                                    ...
                                    >
                                        <option value="vi">
                                            {t('profileManagement.language_vi')}
                                        </option>
                                        <option value="en">
                                            {t('profileManagement.language_en')}
                                        </option>
                                        <option value="ja">
                                            {t('profileManagement.language_ja')}
                                        </option>
                                        <option value="zh">
                                            {t('profileManagement.language_zh')}
                                        </option>
                                    </select>
                                </div>
