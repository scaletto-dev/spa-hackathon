            ...
            <div className='min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 py-20 px-6'>
                ...
                >
                    <div className='bg-white/70 backdrop-blur-xl rounded-3xl border border-white/50 shadow-2xl p-12'>
                            ...
                            <div className='mb-8'>
                                <div className='grid grid-cols-3 gap-4 mb-6'>
                                    <div className='bg-pink-50 rounded-xl p-4 text-center'>
                                        <p className='text-sm text-gray-600 mb-1'>{t('quiz.results.skinType')}</p>
                                        <p className='font-bold text-pink-600 capitalize'>
                                            {analysisResult.analysis.skinType}
                                        </p>
                                    </div>
                                    <div className='bg-purple-50 rounded-xl p-4 text-center'>
                                        <p className='text-sm text-gray-600 mb-1'>{t('quiz.results.primaryConcern')}</p>
                                        <p className='font-bold text-purple-600 capitalize'>
                                            {analysisResult.analysis.primaryConcern}
                                        </p>
                                    </div>
                                    <div className='bg-rose-50 rounded-xl p-4 text-center'>
                                        <p className='text-sm text-gray-600 mb-1'>{t('quiz.results.riskLevel')}</p>
                        ...
                        <p className='text-center text-gray-600 mb-8 text-lg'>{t('quiz.results.subtitle')}</p>
                                        ...
                                        {analysisResult && (
                                            <>
                                                ...
                                                <p className='text-sm text-pink-600 font-medium mt-2'>
                                                    {recommendation.price.toLocaleString('vi-VN')} VNĐ
                                                </p>
                                            </>
                                        )}
                                    </div>
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 py-20 px-6'>
            <div className='max-w-3xl mx-auto'>
                ...
                <div className='mb-8'>
                    <div className='flex justify-between items-center mb-2'>
                        <span className='text-sm font-medium text-gray-600'>
                            {t('quiz.questionOf', { current: currentQuestion + 1, total: questionStructure.length })}
                        </span>
                ...
                >
                    <h2 className='text-3xl font-bold text-gray-800 mb-8'>{currentQ && getQuestion(currentQ)}</h2>
