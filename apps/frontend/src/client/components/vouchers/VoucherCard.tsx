        ...
        >
            <div className='flex items-start justify-between gap-3 mb-3'>
                ...
                <div className='flex-shrink-0 text-right'>
                    <span className='text-amber-600 font-bold text-xl block'>{discountDisplay}</span>
            ...
            <div className='mb-3 p-3 bg-white rounded-lg border border-amber-100'>
                <div className='flex items-center justify-between gap-2'>
                    <code className='font-mono text-sm font-bold text-gray-900'>{voucher.code}</code>
                    <button
            ...
            <div className='flex items-center justify-between text-xs text-gray-600'>
                <span>{t('voucher.validUntil')} {formatDate(voucher.validUntil)}</span>
                {voucher.usageLimit && (
