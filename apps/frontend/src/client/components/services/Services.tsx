        ...
        <section className='w-full py-24 px-6'>
            <div className='max-w-7xl mx-auto'>
                ...
                >
                    ...
                    <p className='text-gray-600 text-lg max-w-2xl mx-auto'>{t('home.services.subtitle')}</p>
                </motion.div>
                                ...
                                <Link to={`/services/${service.slug}`} className='block h-full'>
                                    <div className='h-full bg-white/70 backdrop-blur-xl rounded-3xl border border-white/50 shadow-xl overflow-hidden hover:shadow-2xl transition-all'>
                                        ...
                                        <div className='p-6'>
                                            {/* Icon */}
                                            <div
                                                className={`w-14 h-14 bg-gradient-to-br ${style.gradient} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                                            >
