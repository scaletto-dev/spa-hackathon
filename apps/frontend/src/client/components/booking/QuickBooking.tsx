                        ...
                        <div className='space-y-6'>
                            ...
                            {formData.service && (
                                <TherapistSelector
                                    ...
                                    onSelect={(therapist) => handleChange('therapist', therapist)}
                                />
                            )}
                            {/* Date & Time Selection */}
                        ...
                        <div className='space-y-4'>
                            {formData.service ? (
                                <div className='p-3 bg-pink-50 rounded-xl'>
                                    ...
                                    <p className='font-medium text-gray-800'>{formData.service.title}</p>
                                    <p className='text-sm text-gray-600'>{formData.service.duration}</p>
                                </div>
                            ) : (
