            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-3xl border border-white/50 shadow-xl p-8 mb-12 max-w-2xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-gray-200">
                        <div className="text-left">
                            ...
                            <p className="text-lg font-bold text-gray-800">{serviceNames}</p>
                        </div>
                ...
                <div className="mt-8 p-4 bg-pink-50 rounded-2xl border border-pink-200 text-left">
                    <p className="text-sm text-gray-700">
                        <span className="font-medium">{t('bookings.confirmationSentTo')}</span>{' '}
                        {bookingData.email}
                    </p>
                    <p className="text-sm text-gray-700 mt-1">
                        <span className="font-medium">{t('bookings.bookingReferenceLabel')}</span>{' '}
                        #BEA
                        {bookingReference}
                    </p>
                </div>
