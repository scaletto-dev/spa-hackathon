...
export function BookingPayment({
    ...
    const [selectedPayment, setSelectedPayment] = useState<
        'ATM' | 'CLINIC' | 'WALLET' | 'CASH' | 'BANK_TRANSFER'
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                {option.icon}
                                <h3
                                    className={`font-semibold ${isDisabled ? 'text-gray-400' : 'text-gray-800'}`}
                                >
                                    {option.label}
                                </h3>
                            </div>
            ...
            {selectedPayment === 'CLINIC' && (
                ...
                >
                    <p className="text-sm text-blue-800">
                        <span className="font-semibold">💳 Pay at Clinic:</span> You can pay when
                        you arrive at our clinic. We accept cash and card payments.
                    </p>
                </motion.div>
            )}
            ...
            {selectedPayment === 'ATM' && (
                ...
                >
                    <p className="text-sm text-gray-800">
                        <span className="font-semibold">🏦 VNPay Payment:</span> You will be
                        redirected to VNPay secure payment gateway to complete your payment.
                        Supports ATM cards, Visa, Mastercard, and Internet Banking.
                    </p>
                </motion.div>
            )}
