...
export function AIHintPanel({ conversationId, onSelectSuggestion, isOpen, onClose }: AIHintPanelProps) {
                    ...
                    <div className='p-4 border-b border-gray-200/50 bg-gradient-to-r from-pink-50/80 via-purple-50/80 to-pink-50/80 backdrop-blur-sm'>
                        <div className='flex items-center justify-between'>
                            <div className='flex items-center gap-2.5'>
                                ...
                                <div>
                                    <h3 className='font-semibold text-gray-900 text-sm'>{t('support.ai.title')}</h3>
                                    <p className='text-xs text-gray-500'>{t('support.ai.subtitle')}</p>
                                </div>
                            </div>
                            <motion.button
                                onClick={onClose}
                    ...
                    <div className='flex-1 overflow-y-auto p-4 space-y-3 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent'>
                        {isLoading ? (
                            ...
                            >
                                ...
                                <p className='text-sm text-gray-600 font-medium'>{t('support.ai.loading')}</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className='text-xs text-gray-400'>{t('support.ai.noSuggestionsDesc')}</p>
                            </motion.div>
                        )}
                    </div>
